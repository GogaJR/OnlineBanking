...
<div class="main-wrapper">
    <div class="card card-list card-list-accounts">
        <div class="list-header">
            <h4>Account Responses</h4>
        </div>
        <a class="row">
            <#if accountResponses??>
                <#assign responseList = accountResponses>
                <#list responseList as response>

                    <span>The ${response.bankName} ${response.response} your account request.</span>

                </#list>
            </#if>
        </a>
    <form method="post" action="/userProfile/accountResponses" align="center">
