...
<body>
<div align="right" class="form-style-2-heading">${admin.name} ${admin.surname}<br><a href="/logout">Log out</a></div>
<form method="post", action="/adminProfile">
    <table align="center">
        <td><button type="submit" name="button" value="signUpBank">SignUpBank</button></td>
    </table>
</form>
</body>
</html>